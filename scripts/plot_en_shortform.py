...
def parse_args():
    ...
    parser.add_argument(
        "--csv_file",
        default="scripts/data/en_shortform.csv",
        help="Path to the leaderboard CSV file (default: scripts/data/en_shortform.csv).",
    )
    parser.add_argument(
        "--label-col",
        default="model",
    ...
    parser.add_argument(
        "--x-col",
        default="Avg. WER",
        help="Column name for x-axis values (default: 'Avg. WER').",
    )
    parser.add_argument(
        "--rtfx-col",
        default="RTFx",
    ...
    parser.add_argument(
        ...
        default=[5, 15],
        metavar=("MIN", "MAX"),
        help="WER axis limits for both plots (default: 5 15).",
    )
    ...
    parser.add_argument(
        "--rtfx-output",
        default="en_shortform_rtfx_wer.png",
        help="Output filename for the RTFx plot (default: en_shortform_rtfx_wer.png).",
    )
    parser.add_argument(
        "--size-output",
        default="en_shortform_size_wer.png",
        help="Output filename for the model-size plot (default: en_shortform_size_wer.png).",
    )
    ...
    parser.add_argument(
        "--custom-model",
        default=None,
        help="Custom model to add to the plot in format 'model,avg_wer,rtfx,size' (e.g., 'MY MODEL,5.2,500,2.0').",
    )
