...
def parse_args():
    ...
    parser.add_argument(
        "--csv_file",
        default="scripts/data/en_longform.csv",
        help="Path to the longform leaderboard CSV file (default: scripts/data/en_longform.csv).",
    )
    parser.add_argument(
        "--label-col",
        default="model_id",
        help="Column name for model labels (default: model_id).",
    )
    parser.add_argument(
        "--wer-col",
        default="Average",
        help="Column name for average WER (default: Average).",
    )
    parser.add_argument(
        "--rtfx-col",
        default="RTFx",
    ...
    parser.add_argument(
        ...
        default=[9, 18],
        metavar=("MIN", "MAX"),
        help="WER axis limits for both plots (default: 5 25).",
    )
    ...
    parser.add_argument(
        ...
        default=[1e2, 1e4],
        metavar=("MIN", "MAX"),
        help="Y-axis limits for the RTFx plot (default: 1e2 1e4).",
    )
    ...
    parser.add_argument(
        "--rtfx-output",
        default="longform_rtfx_wer.png",
        help="Output filename for the RTFx plot (default: longform_rtfx_wer.png).",
    )
    parser.add_argument(
        "--size-output",
        default="longform_size_wer.png",
        help="Output filename for the model-size plot (default: longform_size_wer.png).",
    )
    ...
    parser.add_argument(
        "--custom-model",
        default=None,
        help="Custom model to add to the plot in format 'model_id,average,rtfx,size' (e.g., 'MY MODEL,10.5,1000,2.5').",
    )
...
if __name__ == "__main__":
    ...
    if args.custom_model:
        ...
        if len(parts) != 4:
            raise ValueError(
                "Custom model must have format: 'model_id,average,rtfx,size'"
            )
        custom_row = {
